...
export function renderHomeActivity(element, records, patientId, operationDate) {
  ...
  const postop=elapsed===null?'Enter your operation date below to show your surgery day and recovery progress.':elapsed<0?`Surgery in ${-elapsed} day${elapsed===-1?'':'s'}.`:elapsed===0?'Today is your surgery day · Day 0.':`${elapsed} day${elapsed===1?'':'s'} post-operatively`;
