...
import {EXERCISE_NAMES,METRICS,finite,postOpDay,measurementSeries} from './progress-data.mjs';
...
const counterLabel=r=>({patient_voice:'Your spoken count',knee_tracker:'Live knee tracker count',monitoring:'Live camera count',timer:'Completed holds'}[r.count_source||'monitoring']||'Recorded count');
