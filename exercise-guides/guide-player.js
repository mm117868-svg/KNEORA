...
export function showExerciseGuide(exercise){
 ...
 video.poster=new URL('videos/'+exercise.id+'.jpg',root);video.src=new URL('videos/'+exercise.id+'.mp4?v=marin-v2',root);video.querySelector('track').src=new URL('videos/'+exercise.id+'.vtt',root);video.load();
